...
function buildTurnContextBlocks({ world, memoryFacts, worldLoreFacts, characters, recentTurns, activeCharacter, trackedItems, secretInfo, storyClock, timelineEvents }) {
...
function buildNarrationPrompt({
  ...
  storyClock, timelineEvents, language, chapterLength, authorMode, authorNote
}) {
...
module.exports = {
  ...
  buildArchivistPrompt, buildTimeSkipPrompt
};
