...
// memoryFacts gains three new fields per the V2 design doc's Data model
// section: status/supersededBy (contradiction resolution, Milestone 4) and
// embedding (the Retriever, Milestone 2). None of the current roles read or
// write them yet -- set here only so every fact already has the right shape
// once those roles exist, instead of needing a backfill migration later.
