...
async function playTurn(saveId, playerAction, { authorMode, authorNote, providerOverride } = {}) {
  const { world, settings, activeCharacter, memoryFacts, worldLoreFacts, characters, itemDefs, trackedItems, allTurns, recentTurns, save } = await gatherTurnContext(saveId, playerAction);
